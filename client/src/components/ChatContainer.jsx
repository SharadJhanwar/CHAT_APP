        ...
        {messagesDummyData.map((msg, i) => (
          ...
          >
            {msg.image ? (
              ...
              <p className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg overflow-hidden mb-8 break-all bg-violet-500/30 text-white ${msg.senderId === '680f50e4f10f3cd28382ecf9'? 'rounded-br-none':'rounded-bl-none'}`}>{msg.text}</p>
            )}
